...
public class Opuesto extends Jugador{
    ...
    //Metodo constructor
    public Opuesto(String nombre, String pais, int errores, int aces, int servicios, int ataques, int bloqueosEfectivos, int bloqueosFallidos){
    ...
    public String toString(){
        return "\n===DATOS DEL JUGADOR OPUESTO: " + nombre + "===" + 
        "\nNombre: " + nombre + 
        "\nPais de origen: " + pais + 
        "\nErrores: " + errores +
        "\nAces: " + aces +
